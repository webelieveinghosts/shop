      ...
      <div className="flex w-full items-center">
        <div className="hidden md:flex w-1/3">
          <ul className="gap-6 text-xs md:flex md:items-center uppercase">
            <li>
              <a
                className="text-black/60 underline-offset-4 hover:text-black hover:underline transition-all duration-300"
                href="/"
              >
                Início
              </a>
        ...
        <div className="flex w-full md:justify-center md:w-1/3">
          ...
          <a
            className="flex items-center justify-center w-full md:w-auto lg:mr-6"
            href="/"
          >
            <Logo className="w-14" />
          </a>
