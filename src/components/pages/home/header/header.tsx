            ...
            <div className="md:col-span-4 md:row-span-2">
                {mobile ?
                    <div className="group flex h-full w-full items-center justify-center overflow-hidden rounded-lg border border-gray-400 hover:border-primary">
                        <img decoding="async" className="relative h-full w-full object-cover transition duration-300 ease-in-out group-hover:scale-105" src="/image/slide/banner-mobile.png" />
                    </div> :
                    <div className="group flex items-center justify-center overflow-hidden rounded-lg border border-gray-400 hover:border-primary">
                        <img decoding="async" className="relative w-full transition duration-300 ease-in-out group-hover:scale-105" src="/image/slide/banner-pc.png" />
                    </div>
                }
            </div>
        </section >
